...
function Fixed_SearchMasterDayByProducts({ onSearch }) {
        ...
        <React.Fragment>
            ...
            <Box maxWidth="xl" sx={{ width: "100%" , height: 50}}>
                <Grid container spacing={0} style={{width: 1350 }}> 
                    ...
                    <div style={{marginLeft: 40 , marginTop: 10 , display: 'grid', placeItems: 'center' , 
                            width: 60 , height: 50 , color: 'red' ,fontWeight: 'bold'}}>
...
export default Fixed_SearchMasterDayByProducts